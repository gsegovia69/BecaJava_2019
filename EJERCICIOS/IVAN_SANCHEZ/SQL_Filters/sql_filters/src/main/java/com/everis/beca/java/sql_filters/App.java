...
//    		st.executeUpdate(queryInsert);
			...
			// 2. PINTAR POR CONSOLA NOMBRE Y EMAIL DE TODOS LOS ALUMNOS DE LA BBDD QUE
			// TENGAN UNA 'S' EN EL NOMBRE
			...
			// 3. PINTAR POR SONOLA EL NOMBRE DE ALUMNO Y NOMBRE DE CURSO DE TODOS LOS
			// ALUMNOS DE LA BBDD QUE TENGAN UNA 'A' EN EL APELLIDO
			...
			// 4. PINTAR POR CONSOLA NOMBRE DE ALUMNO, NOMBRE DE CLASE Y NOMBRE DE
			// ASIGNATURAS DE TODOS LOS ALUMNOS DE LA BBDD
