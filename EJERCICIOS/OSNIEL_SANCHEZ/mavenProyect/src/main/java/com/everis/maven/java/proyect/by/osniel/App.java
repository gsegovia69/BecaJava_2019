	...
	public static void main( String[] args ){
		try {
			...
			while (opcion <= 3) {
				System.out.println("******************************************************");
				if(opcion == 0) {
					System.out.println(String.valueOf(opcion) + ": Todos los alumnos");
					...
					System.out.println(String.valueOf(opcion) + ": Alumnos que contienen una s en el nombre");
					...
					System.out.println(String.valueOf(opcion)+ ": Alumnos que contienen una a en el apellido..........");
					...
					System.out.println(String.valueOf(opcion) + ": Alumnos , Clase y Asignatura...........");
