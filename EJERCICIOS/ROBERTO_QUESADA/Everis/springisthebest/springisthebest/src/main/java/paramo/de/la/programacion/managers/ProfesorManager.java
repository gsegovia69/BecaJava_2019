...
public class ProfesorManager {
	...
	public ProfesorDTO giveMeOneProfesor(Long id) {
	...
	public  void borramelo(ProfesorDTO dto) {
		Profesor entity = transformDTO(dto);
	...
	private Profesor transformDTO(ProfesorDTO profesor) {
		...
		entity.setApellidos(profesor.getApellidos());
		entity.setCiudad(profesor.getCiudad());
		entity.setEmail(profesor.getEmail());
