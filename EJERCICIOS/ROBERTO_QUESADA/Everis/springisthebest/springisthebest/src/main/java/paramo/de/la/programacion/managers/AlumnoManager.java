...
public class AlumnoManager {
	...
	public AlumnoDTO giveMeOneAlumno(Long id) {
	...
	public Page<Alumno> findAllByOrderByName(Pageable pageable) {
		Page<Alumno> listaEntities = repository.findAllByOrderByNombre(pageable);
...
//		 Page<AlumnoDTO> dtoPage;
	...
	public void borramelo(AlumnoDTO dto) {
